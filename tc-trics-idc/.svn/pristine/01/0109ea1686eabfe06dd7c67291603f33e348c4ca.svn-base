...
$(function () {
                    ...
                    if (data.code == '0') {
                        if(data.data == null || data.data.length == 0){
                            ...
                            var column =  [
                                ...
                                ,{field:'resTypeName', title: '设备类型',formatter:function (value,row,index) {
                                ...
                                ,{field:'model', title: '规格型号', formatter:function (value,row,index) {
                                        var values=row.model;
                                        if(values==undefined){
                                            values='--'
                                        }
                                        var span=document.createElement('span');
                                ...
                                ,{field:'roomName', title: '机房名称',formatter:function (value,row,index) {
                                ...
                                ,{field:'ps', title: '失败原因',formatter:function (value,row,index) {
                                        var values=row.ps;
                                        if(values==undefined){
                                            values='--'
                                        }
                            ...
                            // $("#errorTable").on('load-success.bs.table',function () {
                            //
   ...
   var columns =  [
        ...
        ,{field:'id', title: '操作',width:280,class:'active1',formatter: addFunctionAlty}
    ];
                    ...
                    for (var j = 0;j<resExtCfgList.length;j++){
                        if(resExtCfgList[j].valType == '6362335975393198082'){
                            ...
                            str+= "<div class='form-group col-sm-2'>" +
                                ...
                                "  <input class='form-control ext'  name='"+resExtCfgList[j].itemCode+"' title='"+resExtCfgList[j].itemName+"'  placeholder='"+resExtCfgList[j].itemName+"'>" +
                                "  </div>";
                        }
