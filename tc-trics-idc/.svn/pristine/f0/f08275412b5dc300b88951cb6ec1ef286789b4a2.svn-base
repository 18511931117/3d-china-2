...
public class AppDataController {
    ...
    public ResultResponse getOrgCurrentUser(SysUser sysUser) {
        List<SysUser> list =sysUserService.getAppOrgCurrentUser(sysUser);
        return DataSetUtile.setSuccessResult(list);
    }
     ...
     * @return
     */
    @GetMapping(value = "getOrgCurrentRoom")
    @ResponseBody
    public ResultResponse getOrgByRoom(Room room, PageRequest pageRequest){
        List<RoomExt> list = roomService.getOrgCurrentRoom(room,pageRequest);
        return DataSetUtile.setSuccessResult(list);
    }
