 ...
 * @Description:
 */
public class ExportPOIUtils<T> {

    //参数说明:  fileName：文件名   projects：对象集合  columnNames： 列名   keys： map中的key
    public static void start_download(HttpServletResponse response, String fileName, List<Map<String,Object>> projects,
    ...
    private static List<Map<String, Object>> createExcelRecord(List<Map<String,Object>> projects, String[] keys) {
     ...
     * 利用反射  根据属性名获取属性值
     * */
    private static Object getFieldValueByName(String fieldName, Map o) {
        try {
            /*String firstLetter = fieldName.substring(0, 1).toUpperCase();
            String getter = "get" + firstLetter + fieldName.substring(1);
            Method method = o.getClass().getMethod(getter, new Class[] {});
            Object value = method.invoke(o, new Object[] {});*/
            Object o1 = o.get(fieldName);
            if("isPrinted".equals(fieldName)){
                Double d = (Double) o1;
                if(d.intValue() == 0){
                    o1 = "未打印";
                }else{
    ...
    private static Workbook createWorkBook(List<Map<String, Object>> list,String []keys,String columnNames[]) {
       ...
       /* cs.setBorderLeft(BorderStyle.THIN);
        ...
        palette.setColorAtIndex(HSSFColor.LIME.index, (byte) 0, (byte) 128, (byte) 0);
        return wb;
    }
