...
public class SnowflakeIdWorker {
    ...
    private static Map<String, SnowflakeIdWorker> cache = new HashMap<String, SnowflakeIdWorker>();
    ...
    public static SnowflakeIdWorker getInstance(long workerId, long datacenterId){
    	...
    	SnowflakeIdWorker sfw = cache.get(key);
    	if(null == sfw){
    		sfw = new SnowflakeIdWorker(workerId, datacenterId);
    	}
    	cache.put(key, sfw);
