...
public class ScrapTaskController {
    ...
    public ResultResponse desc(ScrapTask scrapTask,PageRequest pageRequest) {
        PageInfo<ScrapTaskDesc> pageInfo  =scrapTaskService.desc(scrapTask,pageRequest);
    ...
    @RequestMapping(value = "/app/updateScrapTaskState", method = RequestMethod.POST)
    @ApiOperation(value = "报废任务状态变更", httpMethod = "POST")
    public ResultResponse updateScrapTaskState(ScrapTask scrapTask) {
        scrapTaskService.updateState(scrapTask);
        return DataSetUtile.setSuccessResult(null);
    }
    //***********************************手持机报废任务接口**************************************//
