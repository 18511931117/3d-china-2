...
public class RepairTaskServiceImpl extends BaseTaskServiceImpl  implements RepairTaskService {
    ...
    public void delete(RepairTask repairTask) {
        ...
        //撤销设备状态
        List<Long> byTaskIdResIdList = repairTaskDescMapper.getByTaskIdResIdList(repairTaskDesc.getTaskId());
    ...
    public List<RepairTaskDesc> export(RepairTask repairTask) {
        ...
        Arrays.stream(repairTask.getIds().split(",")).forEach(id->
                ids.add(Long.parseLong(id)));
        return  repairTaskDescMapper.selectByExport(ids);
    }
