...
//         var data = obj.data
//         if(obj.event === 'export'){
//             window.location.href='/borrowLog/export?taskId='+data.taskId
...
window.operateEvents = {
    'click #bind': function (e, value, row, index) {
        window.location.href='/borrowLog/export?taskId='+row.taskId
    },'click #desc': function (e, value, row, index) {
        window.location.href = ctxPath+"borrowTask/toDesc?id="+row.taskId
    }
};
$('#test').bootstrapTable({
    url: ctxPath+'borrowLog/getPage',
    method: 'GET',
    ...
    columns:
        [{checkbox: true,width: 50}
            ...
            ,{field:'barcode', title: '操作',width:145, events: operateEvents,class:"active1",formatter: addFunctionAlty, }//表格中增加按钮
        ]
});
