                                ...
                                for(var i = 0 ;i<dev.length;i++){
                                    ...
                                    for (var j = 0;j<resExtCfgList.length;j++){
                                        str+= "<div class='form-group col-sm-2'>" +
                                            ...
                                            "  <input class='form-control ext' value='"+(eval("bean."+resExtCfgList[j].itemCode) != '' && eval("bean."+resExtCfgList[j].itemCode) != undefined ? eval("bean."+resExtCfgList[j].itemCode) : '') +"' name='"+resExtCfgList[j].itemCode+"'  placeholder='"+resExtCfgList[j].itemName+"'  disabled='disabled' readonly='true'>" +
                                            "  </div>";
                                    }
                                    str+= "</div></div>";
                                    ele.append(str);
