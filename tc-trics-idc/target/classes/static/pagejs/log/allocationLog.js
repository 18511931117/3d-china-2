...
//         //console.log(obj)
//         if(obj.event === 'export'){
//             window.location.href='/allocationLog/export?taskId='+data.taskId
...
window.operateEvents = {
    'click #bind': function (e, value, row, index) {
        window.location.href='/allocationLog/export?taskId='+row.taskId
    },'click #desc': function (e, value, row, index) {
        window.location.href = ctxPath+"allocationTask/toDesc?id="+row.taskId
    }
};
$('#test').bootstrapTable({
    url: ctxPath+'allocationLog/getPage',
    method: 'GET',
    ...
    columns:
        [{checkbox: true,width: 50}
            ...
            ,{field:'barcode', title: '操作',events: operateEvents,class:'active1',formatter: addFunctionAlty, width: 145
