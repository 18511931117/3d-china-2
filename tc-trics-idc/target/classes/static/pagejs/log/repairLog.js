...
//         var data = obj.data
//         if(obj.event === 'export'){
//             window.location.href='/repairLog/export?taskId='+data.taskId
...
window.operateEvents = {
    'click #bind': function (e, value, row, index) {
        window.location.href='/repairLog/export?taskId='+row.taskId
    },'click #desc': function (e, value, row, index) {
        window.location.href = ctxPath+"repairTask/toDesc?id="+row.taskId
    }
};
$('#test').bootstrapTable({
    url: ctxPath+'repairLog/getPage',
    method: 'GET',
