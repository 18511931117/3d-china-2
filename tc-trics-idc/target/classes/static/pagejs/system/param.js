    ...
    $('#demo1').bootstrapTable({
        ...
        columns:
            [{checkbox: true,width: 50}
                ...
                ,{field:'id', title: '操作',events: operateEvents,class:'active1',formatter: addFunctionAlty,width: 145}
            ]
    });
})
